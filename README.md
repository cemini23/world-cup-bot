...
<!-- ci-badge-updated:2026-05-30T19:45:01Z -->
...
**CI:** failing · **Status:** feature-complete v1 — **shadow mode first** (`DRY_RUN=true`). Public launch tied to [Outlier Weekly](https://outlierweekly.substack.com) Issue 3 (2026-06-03). Logic version: `wc_advance_lp_v4` · paper arb: `wc_cross_venue_paper_v1`. See [ROADMAP.md](ROADMAP.md) for open operator items.
