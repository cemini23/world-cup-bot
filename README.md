...
<!-- ci-badge-updated:2026-06-02T11:56:08Z -->
...
**CI:** failing · **Status:** feature-complete v1 — **shadow mode first** (`DRY_RUN=true`). Public launch: [Outlier Weekly](https://outlierweekly.substack.com) Issue 3 (2026-06-03). Logic version: `wc_advance_lp_v4` · paper arb: `wc_cross_venue_paper_v1` · exec: `wc_cross_venue_exec_v1`. See [ROADMAP.md](ROADMAP.md) for shipped features and planned work.
