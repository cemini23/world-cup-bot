...
| `config/strategy_logic_versions.yaml` | PnL attribution version (`wc_advance_lp_v5` current) |
...
world-cup-bot venue-reconcile autofill [--logic-version wc_advance_lp_v5]
world-cup-bot venue-reconcile backfill
world-cup-bot venue-reconcile compare <polymarket-export.csv> [--logic-version wc_advance_lp_v5]
